...
<details>
  ...
  ```html
  <rp-button @click="handleButtonClick">Click Me</rp-button>
  ```
...
<details>
  ...
  <rp-table-column label="操作">
    <template slot-scope="props">
      <rp-button @click.native="showDetail(props.row)">查看详情</rp-button>
    </template>
  </rp-table-column>
  ```
  参数 `row` 即为对应行的数据。
...
<details>
  ...
  <rp-table-column label="Operations">
    <template slot-scope="props">
      <rp-button @click.native="showDetail(props.row)">Details</rp-button>
    </template>
  </rp-table-column>
  ```
...
<details>
  ...
  ```html
  <rp-button @click="handleButtonClick">Haga Clic Aquí</rp-button>
  ```
...
<details>
  ...
  ```html
  <rp-table-column label="Operaciones">
    <template slot-scope="props">
      <rp-button @click.native="verDetalles(props.row)">Detalles</rp-button>
    </template>
  </rp-table-column>
  ```
