            ...
            <div class="container">
                <h1>
                    <router-link :to="`/${lang}`">
                        <!-- logo -->
                        <slot>
                            <img src="../assets/images/ruipeng-logo.svg" alt="ruipeng-logo" class="nav-logo" />
                            <img src="../assets/images/ruipeng-logo-small.svg" alt="ruipeng-logo" class="nav-logo-small" />
                        </slot>
                    </router-link>
                </h1>
...
export default {
    ...
    methods: {
        ...
        switchLang(targetLang) {
            ...
            localStorage.setItem('RUIPENG_LANGUAGE', targetLang)
