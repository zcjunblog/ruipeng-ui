<template>
    <rp-color-picker class="theme-picker" popper-class="theme-picker-dropdown" v-model="theme"></rp-color-picker>
</template>
...
.theme-picker .rp-color-picker__trigger {
    vertical-align: middle;
}

.theme-picker-dropdown .rp-color-dropdown__link-btn {
    display: none;
}
</style>
...
export default {
    ...
    watch: {
        theme(val, oldVal) {
            ...
            if (!this.chalk) {
                // TODO: 这里的cdn链接需要处理一下
                const url = `https://unpkg.com/ruipeng-ui@${version}/lib/theme-chalk/index.css`
