    ...
    <div class="component-preview">
        ...
        <el-row class="demo-line">
            <el-checkbox-group v-model="checked1">
                <el-checkbox-button v-for="city in ['Shanghai', 'Beijing', 'Guangzhou', 'Shenzhen']" :label="city" :key="city">
                    {{ city }}
                </el-checkbox-button>
            </el-checkbox-group>
        </el-row>
        ...
        <el-row>
            ...
            <el-switch style="margin-left: 40px" v-model="switchValue" active-text="Pay by month" inactive-text="Pay by year"></el-switch>
        </el-row>
        <h4>Slider</h4>
        ...
        <el-row>
            ...
            <el-rate class="demo-line" v-model="rate" show-score text-color="#ff9900" score-template="{value} points"></el-rate>
        </el-row>
        <h4>Transfer</h4>
        <el-row>
        ...
        <el-row style="width: 380px;">
            ...
            <el-alert class="demo-item" title="error alert" type="error" description="more text description" show-icon></el-alert>
        </el-row>
        <h4>Loading</h4>
        <el-row>
        ...
        <el-row>
            <div class="el-message-box">
                ...
                <div class="el-message-box__content">
                    ...
                    <div class="el-message-box__message"><p>This will permanently delete the file. Continue?</p></div>
        ...
        <el-row>
            <div role="alert" class="el-notification right" style="position: relative; left: 0;">
                ...
                <div class="el-notification__group">
                    ...
                    <div class="el-notification__content"><div>This is a message</div></div>
