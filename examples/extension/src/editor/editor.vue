<template>
    <div class="ext-panel" :class="{ moving: moving }" :style="{ top: `${top}px`, left: `${left}px` }" ref="editor">
        ...
        <div class="editor" :style="{ height: `${height}px` }" v-show="showSidebar">
            <rp-tabs v-model="activeTab" @tab-click="onTabClick">
                <rp-tab-pane label="Config" name="config">
                    <theme-configurator
                ...
                <rp-tab-pane label="Gallery" name="gallery">
...
<style>
.ext-panel .editor .rp-tabs__content,
.ext-panel .editor .rp-tabs--top,
.ext-panel .editor .rp-tab-pane {
    height: 100%;
}
.ext-panel .rp-tabs__nav-scroll > div {
