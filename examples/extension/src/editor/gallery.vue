<template>
    ...
    >
        ...
        <rp-dialog :visible.sync="copyDialogVisible" :modal-append-to-body="false">
            <rp-form :model="copyForm" ref="copyForm" :rules="copyFormRule">
                <rp-form-item label="主题名称" prop="name">
                    <rp-input v-model="copyForm.name"></rp-input>
                </rp-form-item>
            </rp-form>
            <div slot="footer" class="dialog-footer">
                <rp-button @click="closeCopyForm">取消</rp-button>
                <rp-button type="primary" @click="copyToUser">确认</rp-button>
            </div>
        </rp-dialog>
    </div>
</template>
