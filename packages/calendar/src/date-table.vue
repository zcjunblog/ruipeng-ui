            ...
            >
                ...
                <tbody>
                    {this.rows.map((row, index) => (
                        <tr
                            class={{
                                'rp-calendar-table__row': true,
                                'rp-calendar-table__row--hide-border': index === 0 && this.hideHeader
                            }}
                            key={index}
                        >
                            {row.map((cell, key) => (
                                <td key={key} class={this.getCellClass(cell)} onClick={this.pickDay.bind(this, cell)}>
                                    <div class="rp-calendar-day">{this.cellRenderProxy(cell)}</div>
                                </td>
                            ))}
                        </tr>
                    ))}
