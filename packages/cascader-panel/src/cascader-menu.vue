...
export default {
    ...
    methods: {
        ...
        renderEmptyText(h) {
            return <div class="rp-cascader-menu__empty-text">{this.t('el.cascader.noData')}</div>
        },
        renderNodeList(h) {
            const { menuId } = this
            ...
            return [...nodes, isHoverMenu ? <svg ref="hoverZone" class="rp-cascader-menu__hover-zone" /> : null]
        }
    },
    ...
    render(h) {
        ...
        return (
            <rp-scrollbar
                ...
                role="menu"
                id={menuId}
                class="rp-cascader-menu"
                wrap-class="rp-cascader-menu__wrap"
                view-class={{
                    'rp-cascader-menu__list': true,
                    'is-empty': isEmpty
                }}
                {...events}
            >
