...
import RpRadio from 'ruipeng-ui/packages/radio'
import { isEqual } from 'ruipeng-ui/src/utils/util'
...
export default {
    ...
    methods: {
        ...
        renderCheckbox(h) {
            ...
            return <rp-checkbox value={node.checked} indeterminate={node.indeterminate} disabled={isDisabled} {...events} />
        },
        ...
        renderCheckIcon(h) {
            return <i class="rp-icon-check rp-cascader-node__prefix" />
        },

        renderLoadingIcon(h) {
            return <i class="rp-icon-loading rp-cascader-node__postfix" />
        },

        renderExpandIcon(h) {
            return <i class="rp-icon-arrow-right rp-cascader-node__postfix" />
        },
        ...
        renderContent(h) {
            ...
            return <span class="rp-cascader-node__label">{vnode || node.label}</span>
        }
    },
