<template>
    ...
    >
        <tbody>
            ...
            <tr class="rp-date-table__row" v-for="(row, key) in rows" :class="{ current: isWeekActive(row[1]) }" :key="key">
...
import { arrayFindIndex, arrayFind, coerceTruthyValueToArray } from 'ruipeng-ui/src/utils/util'
