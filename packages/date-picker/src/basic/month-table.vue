<template>
    <table @click="handleMonthTableClick" @mousemove="handleMouseMove" class="rp-month-table">
        <tbody>
...
import { isDate, range, getDayCountOfMonth, nextDate } from 'ruipeng-ui/src/utils/date-util'
import { hasClass } from 'ruipeng-ui/src/utils/dom'
import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'ruipeng-ui/src/utils/util'
...
export default {
    ...
    methods: {
        ...
        getCellStyle(cell) {
            ...
            style.current =
                arrayFindIndex(coerceTruthyValueToArray(this.value), date => date.getFullYear() === year && date.getMonth() === month) >= 0
