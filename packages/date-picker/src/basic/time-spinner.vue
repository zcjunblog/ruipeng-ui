<template>
    <div class="rp-time-spinner" :class="{ 'has-seconds': showSeconds }">
        <template v-if="!arrowControl">
            <rp-scrollbar
                @mouseenter.native="emitSelectRange('hours')"
                @mousemove.native="adjustCurrentSpinner('hours')"
                class="rp-time-spinner__wrapper"
                wrap-style="max-height: inherit;"
                view-class="rp-time-spinner__list"
                noresize
                tag="ul"
                ref="hours"
            >
        ...
        <template v-if="arrowControl">
            <div @mouseenter="emitSelectRange('hours')" class="rp-time-spinner__wrapper is-arrow">
                <i v-repeat-click="decrease" class="rp-time-spinner__arrow rp-icon-arrow-up"></i>
                <i v-repeat-click="increase" class="rp-time-spinner__arrow rp-icon-arrow-down"></i>
                <ul class="rp-time-spinner__list" ref="hours">
                    <li
                        class="rp-time-spinner__item"
            ...
            <div @mouseenter="emitSelectRange('minutes')" class="rp-time-spinner__wrapper is-arrow">
                <i v-repeat-click="decrease" class="rp-time-spinner__arrow rp-icon-arrow-up"></i>
                <i v-repeat-click="increase" class="rp-time-spinner__arrow rp-icon-arrow-down"></i>
                <ul class="rp-time-spinner__list" ref="minutes">
                    <li
                        class="rp-time-spinner__item"
            ...
            <div @mouseenter="emitSelectRange('seconds')" class="rp-time-spinner__wrapper is-arrow" v-if="showSeconds">
                <i v-repeat-click="decrease" class="rp-time-spinner__arrow rp-icon-arrow-up"></i>
                <i v-repeat-click="increase" class="rp-time-spinner__arrow rp-icon-arrow-down"></i>
                <ul class="rp-time-spinner__list" ref="seconds">
                    <li
...
import { getRangeHours, getRangeMinutes, modifyTime } from 'ruipeng-ui/src/utils/date-util'
import RpScrollbar from 'ruipeng-ui/packages/scrollbar'
import RepeatClick from 'ruipeng-ui/src/directives/repeat-click'
