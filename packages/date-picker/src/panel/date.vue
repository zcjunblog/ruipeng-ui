<template>
    <transition name="rp-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
        <div
            v-show="visible"
            class="rp-picker-panel rp-date-picker rp-popper"
            :class="[
                {
        ...
        >
            <div class="rp-picker-panel__body-wrapper">
                ...
                <div class="rp-picker-panel__body">
                    <div class="rp-date-picker__time-header" v-if="showTime">
                        <span class="rp-date-picker__editor-wrap">
                            <rp-input
                        ...
                        <span class="rp-date-picker__editor-wrap" v-clickoutside="handleTimePickClose">
                            <rp-input
                                ref="input"
                    ...
                    <div
                        class="rp-date-picker__header"
                        :class="{ 'rp-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
                    ...
                    >
                        <button
                            ...
                            class="rp-picker-panel__icon-btn rp-date-picker__prev-btn rp-icon-d-arrow-left"
                        ></button>
                        <button
                            type="button"
                            @click="prevMonth"
                            ...
                            class="rp-picker-panel__icon-btn rp-date-picker__prev-btn rp-icon-arrow-left"
                        ></button>
                        <span @click="showYearPicker" role="button" class="rp-date-picker__header-label">{{ yearLabel }}</span>
                        <span
                            @click="showMonthPicker"
                            v-show="currentView === 'date'"
                            role="button"
                            class="rp-date-picker__header-label"
                        ...
                        <button
                            ...
                            class="rp-picker-panel__icon-btn rp-date-picker__next-btn rp-icon-d-arrow-right"
                        ></button>
                        <button
                            type="button"
                            @click="nextMonth"
                            ...
                            class="rp-picker-panel__icon-btn rp-date-picker__next-btn rp-icon-arrow-right"
                        ></button>
                    </div>

                    <div class="rp-picker-panel__content">
                        <date-table
                            v-show="currentView === 'date'"
                            @pick="handleDatePick"
            ...
            <div class="rp-picker-panel__footer" v-show="footerVisible && currentView === 'date'">
                <rp-button size="mini" type="text" class="rp-picker-panel__link-btn" @click="changeToNow" v-show="selectionMode !== 'dates'">
                    {{ t('el.datepicker.now') }}
                </rp-button>
                <rp-button plain size="mini" class="rp-picker-panel__link-btn" @click="confirm">
