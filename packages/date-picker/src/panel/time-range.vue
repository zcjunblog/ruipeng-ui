<template>
    <transition name="rp-zoom-in-top" @after-leave="$emit('dodestroy')">
        <div v-show="visible" class="rp-time-range-picker rp-picker-panel rp-popper" :class="popperClass">
            <div class="rp-time-range-picker__content">
                <div class="rp-time-range-picker__cell">
                    <div class="rp-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div>
                    <div
                        :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
                        class="rp-time-range-picker__body rp-time-panel__content"
                    >
                        <time-spinner
                            ref="minSpinner"
                ...
                <div class="rp-time-range-picker__cell">
                    <div class="rp-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div>
                    <div
                        :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
                        class="rp-time-range-picker__body rp-time-panel__content"
                    >
            ...
            <div class="rp-time-panel__footer">
                <button type="button" class="rp-time-panel__btn cancel" @click="handleCancel()">{{ t('el.datepicker.cancel') }}</button>
                <button type="button" class="rp-time-panel__btn confirm" @click="handleConfirm()" :disabled="btnDisabled">
...
import { parseDate, limitTimeRange, modifyDate, clearMilliseconds, timeWithinRange } from 'ruipeng-ui/src/utils/date-util'
