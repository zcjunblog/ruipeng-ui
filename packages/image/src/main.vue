<template>
    <div class="rp-image">
        <slot v-if="loading" name="placeholder">
            <div class="rp-image__placeholder"></div>
        </slot>
        <slot v-else-if="error" name="error">
            <div class="rp-image__error">{{ t('el.image.error') }}</div>
        </slot>
        <img
            v-else
            class="rp-image__inner"
            v-bind="$attrs"
            v-on="$listeners"
            @click="clickHandler"
            :src="src"
            :style="imageStyle"
            :class="{ 'rp-image__inner--center': alignCenter, 'rp-image__preview': preview }"
        />
