...
export default {
    ...
    methods: {
        ...
        getColumnRpIndex(children, child) {
        ...
        setColumnRenders(column) {
            ...
            if (this.renderHeader) {
                console.warn(
                    '[Rpement Warn][TableColumn]Comparing to render-header, scoped-slot header is easier to use. We recommend users to use scoped-slot header.'
                )
    ...
    mounted() {
        ...
        const columnIndex = this.getColumnRpIndex(children, this.$el)
