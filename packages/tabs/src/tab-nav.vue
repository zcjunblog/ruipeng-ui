...
export default {
    ...
    render(h) {
        ...
        const scrollBtn = scrollable
            ? [
                  <span class={['rp-tabs__nav-prev', scrollable.prev ? '' : 'is-disabled']} on-click={scrollPrev}>
                      <i class="rp-icon-arrow-left" />
                  </span>,
                  <span class={['rp-tabs__nav-next', scrollable.next ? '' : 'is-disabled']} on-click={scrollNext}>
        ...
        return (
            <div class={['rp-tabs__nav-wrap', scrollable ? 'is-scrollable' : '', `is-${this.rootTabs.tabPosition}`]}>
                {scrollBtn}
                <div class={['rp-tabs__nav-scroll']} ref="navScroll">
                    <div
                        class={[
                            'rp-tabs__nav',
