...
describe('Autocomplete', () => {
    ...
    it('create', done => {
      ...
      `,
        ...
        setTimeout(_ => {
            ...
            expect(suggestions.querySelectorAll('.rp-autocomplete-suggestion__list li').length).to.be.equal(4)
    ...
    it('select', done => {
      ...
      `,
        ...
        setTimeout(_ => {
            ...
            const suggestionList = suggestions.querySelectorAll('.rp-autocomplete-suggestion__list li')
    ...
    it('highlight', done => {
      ...
      `,
        ...
        setTimeout(_ => {
            ...
            vm.$nextTick(_ => {
                const suggestions = autocomplete.$refs.suggestions.$el.querySelector('.rp-autocomplete-suggestion__wrap')
                let suggestionsList = suggestions.querySelectorAll('.rp-autocomplete-suggestion__list li')
    ...
    it('highlight out of bounds', done => {
      ...
      `,
        ...
        setTimeout(_ => {
            ...
            vm.$nextTick(_ => {
                const suggestions = autocomplete.$refs.suggestions.$el
                const suggestionsList = suggestions.querySelectorAll('.rp-autocomplete-suggestion__list li')
    ...
    it('can highlight first item', done => {
      ...
      `,
        ...
        setTimeout(_ => {
            const suggestions = vm.$refs.autocomplete.$refs.suggestions.$el
            const items = suggestions.querySelectorAll('.rp-autocomplete-suggestion__list li')
