...
describe('DatePicker', () => {
    ...
    it('select date', done => {
        vm = createVue(
            {
                template: `
        <rp-date-picker ref="compo" v-model="value"></rp-date-picker>
      `,
                data() {
                    return {
                        value: ''
        ...
        setTimeout(_ => {
            ...
            const spans = $el.querySelectorAll('.rp-date-picker__header-label')
            const arrowLeftElm = $el.querySelector('.rp-date-picker__prev-btn.rp-icon-arrow-left')
            const arrowRightElm = $el.querySelector('.rp-date-picker__next-btn.rp-icon-arrow-right')

            expect(spans[0].textContent).to.include(date.getFullYear())
            expect(spans[1].textContent).to.include(date.getMonth() + 1)
            $el.querySelector('.rp-date-picker__prev-btn.rp-icon-d-arrow-left').click()
            let count = 20
            while (--count) {
                arrowLeftElm.click()
            }
    ...
    it('clear value', done => {
        vm = createVue(
            {
                template: `
        <rp-date-picker v-model="value" ref="compo"></rp-date-picker>
      `,
                data() {
                    return {
                        value: ''
    ...
    it('disabled clear value', done => {
        vm = createVue(
            {
                template: `
        <rp-date-picker v-model="value" ref="compo" :clearable="false"></rp-date-picker>
      `,
                data() {
                    return {
                        value: ''
        ...
        setTimeout(_ => {
            ...
            $el.querySelector('td.available').click()
            vm.$nextTick(_ => {
                vm.$el.querySelector('.rp-input__icon').click()
                setTimeout(_ => {
    ...
    it('reset', done => {
      ...
      `,
        ...
        setTimeout(_ => {
            const $el = vm.$refs.compo.picker.$el
            $el.querySelector('.rp-date-picker__next-btn.rp-icon-arrow-right').click()
            setTimeout(_ => {
                $el.querySelector('td.available').click()
                vm.$nextTick(_ => {
                    vm.value = ''
    ...
    it('focus', done => {
        vm = createVue(
            {
                template: `
        <rp-date-picker ref="picker"></rp-date-picker>
      `
            },
            true
        )
    ...
    it('nuke invalid input on close', done => {
        vm = createVue(
            {
                template: '<rp-date-picker v-model="value" value-format="yyyy-MM-dd" ref="compo" />',
                data() {
                    return {
                        value: '2010-10-01'
                    }
    ...
    it('select datetime with defaultTime', done => {
        vm = createVue(
            {
                template: `
        <rp-date-picker ref="compo" type="datetime" v-model="value" default-time="12:00:00"></rp-date-picker>
      `,
                data() {
                    return {
                        value: ''
    ...
    describe('value-format', () => {
        ...
        it('emits', done => {
          ...
          <rp-date-picker
            ...
            setTimeout(_ => {
                vm.$refs.compo.picker.$el.querySelector('.rp-date-table td.available').click()
                setTimeout(_ => {
        ...
        it('accepts', done => {
          ...
          <rp-date-picker
            ...
            setTimeout(_ => {
                ...
                vm.$refs.compo.picker.$el.querySelector('.rp-date-table .current').click()
                setTimeout(_ => {
                    expect(input.value).to.equal('2000-02-01')
                    done()
                }, DELAY)
    ...
    describe('default value', () => {
        ...
        it('it works', done => {
            ...
            vm = createVue(
                {
                    template: `<rp-date-picker v-model="value" ref="compo" default-value="${defaultValue}" />`,
                    data() {
                        return {
                            value: ''
                        }
            ...
            setTimeout(_ => {
                const $el = vm.$refs.compo.picker.$el
                expect($el.querySelector('.rp-month-table td.default')).to.exist
                expect($el.querySelector('.rp-year-table td.default')).to.exist
                const defaultEls = $el.querySelectorAll('.rp-date-table td.default')
        ...
        it('is reactive, works with clear', done => {
            ...
            setTimeout(_ => {
                ...
                expect($el.querySelector('.rp-date-table td.current')).to.exist
                vm.defaultValue = defaultValue
                triggerEvent(vm.$refs.compo.$el, 'mouseenter')
                setTimeout(_ => {
                    vm.$el.querySelector('.rp-icon-circle-close').click()
                    setTimeout(_ => {
                        input.focus()
                        setTimeout(() => {
                            $el = vm.$refs.compo.picker.$el
                            expect($el.querySelector('.rp-date-table td.current')).to.not.exist
                            expect($el.querySelector('.rp-date-table td.default')).to.exist
                            $el.querySelector('.rp-date-table td.default').click()
                            setTimeout(() => {
                                expect(vm.value).to.eql(expectValue)
                                done()
                            }, DELAY)
    ...
    describe('keydown', () => {
        ...
        beforeEach(done => {
            vm = createVue(
                {
                    template: '<rp-date-picker ref="compo" v-model="value"></rp-date-picker>',
                    data() {
                        return {
                            value: ''
                        }
    ...
    describe('can be cleared using keyboard', () => {
        ...
        it('works for type=date, when blur', done => {
            vm = createVue(
                {
                    template: `
          <rp-date-picker ref="compo" v-model="value" format="yyyy-MM-dd" type="date" />
        `,
                    data() {
                        return {
                            value: new Date()
    ...
    describe('navigation', () => {
        ...
        const initNavigationTest = async value => {
            vm = createVue(
                {
                    template: '<rp-date-picker v-model="value" ref="compo" />',
                    data() {
                        return {
                            value
                        }
            ...
            await wait()
            const $el = vm.$refs.compo.picker.$el
            prevMonth = $el.querySelector('button.rp-icon-arrow-left')
            prevYear = $el.querySelector('button.rp-icon-d-arrow-left')
            nextMonth = $el.querySelector('button.rp-icon-arrow-right')
            nextYear = $el.querySelector('button.rp-icon-d-arrow-right')
            getYearLabel = () => $el.querySelectorAll('.rp-date-picker__header-label')[0].textContent
            getMonthLabel = () => $el.querySelectorAll('.rp-date-picker__header-label')[1].textContent
        }
        ...
        it('month label with fewer dates', async () => {
            await initNavigationTest(new Date(2000, 6, 31))
            const $el = vm.$refs.compo.picker.$el
            const monthLabel = $el.querySelectorAll('.rp-date-picker__header-label')[1]
            await clickAndWait(monthLabel)
            const juneLabel = $el.querySelectorAll('.rp-month-table td a')[5]
    ...
    it('type:month', done => {
        ...
        setTimeout(_ => {
            expect(vm.picker.$el.querySelector('.rp-month-table').style.display).to.be.empty
            expect(vm.picker.$el.querySelector('.rp-year-table').style.display).to.be.equal('none')
            vm.picker.$el.querySelector('.rp-month-table a.cell').click()
    ...
    it('type:year', done => {
        ...
        setTimeout(_ => {
            expect(vm.picker.$el.querySelector('.rp-year-table').style.display).to.empty
            expect(vm.picker.$el.querySelector('.rp-month-table').style.display).to.be.equal('none')

            const leftBtn = vm.picker.$el.querySelector('.rp-icon-d-arrow-left')
            const rightBtn = vm.picker.$el.querySelector('.rp-icon-d-arrow-right')
            let count = 20
            ...
            vm.picker.$el.querySelector('.rp-year-table a.cell').click()
            expect(vm.pickerVisible).to.false
            done()
        }, DELAY)
    })
    ...
    describe('type:datetime', () => {
        ...
        it('create', done => {
            vm = createVue(
                {
                    template: '<rp-date-picker type="datetime" v-model="value" ref="compo" />',
                    data() {
                        return {
                            value: ''
                        }
            ...
            setTimeout(_ => {
                expect(vm.$refs.compo.picker.$el.querySelector('.rp-time-panel')).to.ok
                done()
            }, DELAY)
        })
        ...
        it('both picker show correct formated value (extract date-format and time-format from format property)', done => {
            vm = createVue(
                {
                    template: '<rp-date-picker type="datetime" v-model="value" :format="format" :pickerOptions="pickerOptions" ref="compo" />',
                    data() {
                        return {
            ...
            setTimeout(_ => {
                ...
                const dateInput = datePanel.$el.querySelector('.rp-date-picker__time-header > span:nth-child(1) input')
                const timeInput = datePanel.$el.querySelector('.rp-date-picker__time-header > span:nth-child(2) input')
                timeInput.focus()
                setTimeout(_ => {
        ...
        it('both picker show correct value', done => {
            ...
            setTimeout(_ => {
                ...
                setTimeout(_ => {
                    ...
                    const [hours, minutes, seconds] = timePanel.$el.querySelectorAll('.rp-time-spinner ul li.active')
        ...
        it('click now button', done => {
            ...
            setTimeout(_ => {
                ...
                vm.picker.$el.querySelector('.rp-picker-panel__link-btn').click()
                setTimeout(_ => {
        ...
        it('click timepicker', done => {
            ...
            setTimeout(_ => {
                const input = vm.picker.$el.querySelectorAll('.rp-date-picker__editor-wrap input')[1]
                triggerEvent(input, 'focus')

                setTimeout(_ => {
                    const timePanel = vm.picker.$el.querySelector('.rp-time-panel')
        ...
        it('input date', done => {
            ...
            setTimeout(_ => {
                const input = vm.picker.$el.querySelector('.rp-date-picker__editor-wrap input')
        ...
        it('select time', done => {
            ...
            setTimeout(_ => {
                ...
                setTimeout(_ => {
                    const button = vm.picker.$el.querySelector('.rp-time-panel .confirm')
                    button.click()
            ...
            it('pick date, emits on confirm', done => {
                ...
                setTimeout(_ => {
                    ...
                    setTimeout(_ => {
                        ...
                        vm.$refs.compo.picker.$el.querySelector('.rp-picker-panel__footer .rp-button--default').click()
                        setTimeout(_ => {
        ...
        describe('cancel time', () => {
            ...
            it('cancel to empty', done => {
                ...
                setTimeout(_ => {
                    const timeInput = vm.$refs.compo.picker.$el.querySelector('.rp-date-picker__time-header > span:nth-child(2) input')
                    timeInput.focus()
                    setTimeout(_ => {
        ...
        it('now button: can not choose disabled date', done => {
            vm = createVue(
                {
                    template: '<rp-date-picker type="datetime" v-model="value" ref="compo" :pickerOptions="pickerOptions" />',
                    data() {
                        return {
                            value: '',
                            pickerOptions: {
            ...
            setTimeout(_ => {
                // click now button
                vm.$refs.compo.picker.$el.querySelector('.rp-picker-panel__footer .rp-button--text').click()
                setTimeout(_ => {
                    expect(vm.value).to.equal('')
                    done()
                }, DELAY)
        ...
        it('select time honors picked date', done => {
            ...
            setTimeout(_ => {
                ...
                vm.$refs.compo.picker.$el.querySelector('.rp-date-picker__header .rp-icon-arrow-right').click()
                setTimeout(_ => {
                    vm.$refs.compo.picker.$el.querySelector('.rp-date-picker__header .rp-icon-d-arrow-right').click()
                    setTimeout(_ => {
    ...
    describe('type:week', () => {
        ...
        it('click cell', done => {
            vm.picker.$el.querySelector('.rp-date-table__row .available').click()
            setTimeout(_ => {
        ...
        it('click year label', () => {
            vm.picker.$el.querySelector('.rp-date-picker__header-label').click()
            expect(vm.picker.currentView).to.equal('year')
        })

        it('click month label', () => {
            vm.picker.$el.querySelectorAll('.rp-date-picker__header-label')[1].click()
        ...
        it('select month', done => {
            ...
            setTimeout(_ => {
                vm.picker.$el.querySelector('.rp-month-table .cell').click()

                setTimeout(_ => {
                    expect(vm.picker.$el.querySelector('.rp-date-table.is-week-mode').style.display).to.equal('')
                    done()
                }, DELAY)
            }, DELAY)
        })
        ...
        it('highlight correctly', done => {
            vm = createVue(
                {
                    template: '<rp-date-picker type="week" v-model="value" ref="compo" />',
                    data() {
                        return {
                            value: null
                        }
            ...
            setTimeout(() => {
                ...
                const numberOfHighlightRows = () => pickerEl.querySelectorAll('.rp-date-table__row.current').length
                expect(numberOfHighlightRows()).to.equal(0)
                setTimeout(() => {
                    pickerEl.querySelector('.rp-date-table__row ~ .rp-date-table__row td.available').click()
                    setTimeout(() => {
                        expect(vm.value).to.exist
                        input.blur()
                        input.focus()
                        setTimeout(() => {
                            ...
                            pickerEl.querySelector('.rp-icon-arrow-right').click()
                            setTimeout(() => {
                                expect(numberOfHighlightRows()).to.equal(0)
                                // test: next year should not have highlight
                                pickerEl.querySelector('.rp-icon-arrow-left').click() // go back one month
                                pickerEl.querySelector('.rp-icon-d-arrow-right').click()
                                setTimeout(() => {
                                    expect(numberOfHighlightRows()).to.equal(0)
                                    done()
                                }, DELAY)
    ...
    describe('type:dates', () => {
        ...
        beforeEach(done => {
            vm = createVue(
                {
                    template: '<rp-date-picker type="dates" value-format="timestamp" v-model="value" ref="compo" />',
                    data() {
                        return {
                            value: []
                        }
        ...
        it('click cell', done => {
            const td = vm.$refs.compo.picker.$el.querySelector('.rp-date-table__row .available')
            td.click()
            setTimeout(_ => {
    ...
    describe('type:daterange', () => {
        ...
        it('works', done => {
            vm = createVue(
                {
                    template: '<rp-date-picker type="daterange" v-model="value" ref="compo" />',
                    data() {
                        return {
                            value: ''
                        }
            ...
            setTimeout(_ => {
                const panels = rangePicker.picker.$el.querySelectorAll('.rp-date-range-picker__content')
        ...
        it('type:daterange unlink:true', done => {
            vm = createVue(
                {
                    template: '<rp-date-picker type="daterange" unlink-panels v-model="value" ref="compo" />',
                    data() {
                        return {
            ...
            setTimeout(_ => {
                ...
                setTimeout(_ => {
                    const panels = rangePicker.picker.$el.querySelectorAll('.rp-date-range-picker__content')
                    const left = panels[0].querySelector('.rp-date-range-picker__header')
                    const right = panels[1].querySelector('.is-right .rp-date-range-picker__header')
        ...
        it('unlink panels', done => {
            ...
            setTimeout(_ => {
                const panels = vm.picker.$el.querySelectorAll('.rp-date-range-picker__content')

                expect(Array.prototype.slice.call(panels)).to.length(2)

                panels[1].querySelector('.rp-icon-d-arrow-right').click()
                panels[1].querySelector('.rp-icon-arrow-right').click()
        ...
        describe('default value', () => {
            it('single', done => {
                ...
                vm = createVue(
                    {
                        template: '<rp-date-picker type="daterange" v-model="value" ref="compo" :default-value="defaultValue" />',
                        data() {
                            return {
                                value: '',
                                defaultValue
                ...
                setTimeout(_ => {
                    ...
                    defaultEls[0].click()
                    setTimeout(_ => {
                        $el.querySelector('.rp-date-table td.default + td').click()
                        setTimeout(_ => {
                            expect(vm.value).to.eql(expectValue)
                            done()
                        }, DELAY)
            ...
            it('array', done => {
                ...
                vm.$el.querySelector('input').focus()
                setTimeout(_ => {
                    const defaultEls = vm.$refs.compo.picker.$el.querySelectorAll('.rp-date-table td.default')
    ...
    describe('type:datetimerange', () => {
        ...
        it('create', () => {
            expect(Array.prototype.slice.call(vm.picker.$el.querySelectorAll('.rp-time-panel'))).to.length(2)
        })

        it('select daterange', done => {
            const pickers = vm.picker.$el.querySelectorAll('.rp-date-range-picker__content')
        ...
        it('select daterange with defaultTime min', done => {
            ...
            vm = createVue(
                {
                    template: `
          <rp-date-picker ref="compo" type="datetimerange" v-model="value" :default-time="defaultTime"></rp-date-picker>
        `,
                    data() {
                        return {
                            value: [new Date(2000, 10, 10, 10, 10), new Date(2000, 10, 11, 10, 10)],
        ...
        it('both picker show correct formated value (extract date-format and time-format from format property)', done => {
            ...
            vm = createVue(
                {
                    template: `
          <rp-date-picker ref="compo" type="datetimerange" v-model="value" :format="format"></rp-date-picker>
        `,
                    data() {
                        return {
            ...
            setTimeout(_ => {
                ...
                compo.$el.click()
                setTimeout(_ => {
                    const pickers = compo.picker.$el.querySelectorAll('.rp-date-range-picker__time-header .rp-date-range-picker__editors-wrap')
                    const left = {
                        dateInput: pickers[0].querySelector('.rp-date-range-picker__time-picker-wrap:nth-child(1) input'),
                        timeInput: pickers[0].querySelector('.rp-date-range-picker__time-picker-wrap:nth-child(2) input')
                    }
                    const right = {
                        dateInput: pickers[1].querySelector('.rp-date-range-picker__time-picker-wrap:nth-child(1) input'),
                        timeInput: pickers[1].querySelector('.rp-date-range-picker__time-picker-wrap:nth-child(2) input')
                    }
        ...
        it('prev/next month button', done => {
            const leftBtn = vm.picker.$el.querySelector('.is-left .rp-icon-arrow-left')
            const rightBtn = vm.picker.$el.querySelector('.is-right .rp-icon-arrow-right')
            const left = vm.picker.$el.querySelector('.is-left .rp-date-range-picker__header')
            const right = vm.picker.$el.querySelector('.is-right .rp-date-range-picker__header')
        ...
        it('prev/next year button', done => {
            const leftBtn = vm.picker.$el.querySelector('.is-left .rp-icon-d-arrow-left')
            const rightBtn = vm.picker.$el.querySelector('.is-right .rp-icon-d-arrow-right')
            const left = vm.picker.$el.querySelector('.is-left .rp-date-range-picker__header')
            const right = vm.picker.$el.querySelector('.is-right .rp-date-range-picker__header')
            const leftText = left.textContent.match(/\d+/g)
            const rightText = right.textContent.match(/\d+/g)
        ...
        it('input date', done => {
            const input = vm.picker.$el.querySelector('.rp-date-range-picker__editors-wrap input')
            const pickers = vm.picker.$el.querySelectorAll('.rp-date-range-picker__content')
            const leftCell = pickers[0].querySelector('td.available')
            const rightCell = pickers[1].querySelector('td.available')
        ...
        it('input date when minDate > maxDate', done => {
            const input = vm.picker.$el.querySelector('.rp-date-range-picker__editors-wrap input')
            const input2 = vm.picker.$el.querySelectorAll('.rp-date-range-picker__editors-wrap input')[2]
            const pickers = vm.picker.$el.querySelectorAll('.rp-date-range-picker__content')
            const leftCell = pickers[0].querySelector('td.available')
            const rightCell = pickers[1].querySelector('td.available')
        ...
        it('select time', done => {
            const input = vm.picker.$el.querySelectorAll('.rp-date-range-picker__editors-wrap input')[1]
            input.blur()
            input.focus()
            input.blur()

            setTimeout(_ => {
                const button = vm.picker.$el.querySelector('.rp-date-range-picker__time-picker-wrap .rp-time-panel .confirm')
                button.click()
        ...
        it('confirm honors disabledDate', done => {
            ...
            vm = createVue(
                {
                    template:
                        '<rp-date-picker type="datetimerange" value-format="yyyy-MM-dd HH:mm:ss" v-model="value" :picker-options="pickerOptions" ref="compo" />',
                    data() {
                        return {
                            pickerOptions: {
                                disabledDate(date) {
    ...
    describe('type:monthrange', () => {
        ...
        it('works', done => {
            vm = createVue(
                {
                    template: '<rp-date-picker type="monthrange" v-model="value" ref="compo" />',
                    data() {
                        return {
                            value: ''
                        }
        ...
        it('type:monthrange unlink:true', done => {
            vm = createVue(
                {
                    template: '<rp-date-picker type="monthrange" unlink-panels v-model="value" ref="compo" />',
                    data() {
                        return {
        ...
        describe('default value', () => {
            ...
            it('single', done => {
                ...
                vm = createVue(
                    {
                        template: '<rp-date-picker type="monthrange" v-model="value" ref="compo" :default-value="defaultValue" />',
                        data() {
                            return {
                                value: '',
                                defaultValue
                ...
                setTimeout(_ => {
                    const $el = vm.$refs.compo.picker.$el
                    const defaultEls = $el.querySelectorAll('.rp-month-table td.default')
                    expect(defaultEls.length).to.equal(1)
                    defaultEls[0].click()
                    setTimeout(_ => {
                        $el.querySelector('.rp-month-table td.default + td').click()
                        setTimeout(_ => {
                            expect(vm.value).to.eql(expectValue)
                            done()
                        }, DELAY)
            ...
            it('array', done => {
                ...
                vm.$el.querySelector('input').focus()
                setTimeout(_ => {
                    const defaultEls = vm.$refs.compo.picker.$el.querySelectorAll('.rp-month-table td.default')
                    expect(defaultEls.length).to.equal(2)
                    defaultEls[0].click()
                    setTimeout(_ => {
                        defaultEls[1].click()
    ...
    it('picker-options:shortcuts', done => {
        ...
        setTimeout(_ => {
            const shortcut = vm.picker.$el.querySelector('.rp-picker-panel__shortcut')

            expect(shortcut.textContent).to.be.equal('今天')
            expect(vm.picker.$el.querySelector('.rp-picker-panel__sidebar')).to.be.ok
    ...
    describe('picker-options:selectableRange', () => {
        ...
        it('selectableRange', done => {
            vm = createVue(
                {
                    template: `
        <rp-date-picker v-model="value" type="datetime" :picker-options="pickerOptions" ref="compo"></rp-date-picker>
        `,
                    data() {
                        return {
            ...
            setTimeout(() => {
                const $el = vm.$refs.compo.picker.$el
                const input1 = $el.querySelectorAll('.rp-date-picker__editor-wrap input')[1]
                input1.blur()
                input1.focus()
                setTimeout(_ => {
                    const list = $el.querySelectorAll('.rp-time-spinner__list')
    ...
    describe('picker-options:className', () => {
        it('set custom class name', async () => {
            ...
            vm.$refs.compo.$el.querySelector('input').focus()
            await wait()
            expect(vm.$refs.compo.picker.$el.querySelector('.rp-date-table__row td').className.indexOf('test-class') > -1).to.be.true
        })
    })
})
