...
describe('InputNumber', () => {
    ...
    it('decrease', done => {
        vm = createVue(
            {
                template: `
        <rp-input-number v-model="value" ref="input">
        </rp-input-number>
      `,
                data() {
                    return {
        ...
        let input = vm.$el.querySelector('input')
        let btnDecrease = vm.$el.querySelector('.rp-input-number__decrease')
    ...
    it('increase', done => {
      ...
      `,
        ...
        let input = vm.$el.querySelector('input')
        let btnIncrease = vm.$el.querySelector('.rp-input-number__increase')
    ...
    it('disabled', done => {
        vm = createVue(
            {
                template: `
        <rp-input-number v-model="value" disabled>
        </rp-input-number>
      `,
                data() {
                    return {
    ...
    it('step', done => {
        vm = createVue(
            {
                template: `
        <rp-input-number v-model="value" :step="3.2">
        </rp-input-number>
      `,
                data() {
                    return {
    ...
    it('step strictly', async () => {
        vm = createVue(
            {
                template: `
        <rp-input-number v-model="value" :step="1.2" step-strictly>
        </rp-input-number>
      `,
                data() {
                    return {
    ...
    it('min', done => {
        vm = createVue(
            {
                template: `
        <rp-input-number v-model="value" :min="6">
        </rp-input-number>
      `,
                data() {
                    return {
    ...
    it('max', done => {
        vm = createVue(
            {
                template: `
        <rp-input-number v-model="value" :max="8">
        </rp-input-number>
      `,
                data() {
                    return {
    ...
    describe('precision', () => {
        it('precision is 2', () => {
            vm = createVue(
                {
                    template: `
          <rp-input-number v-model="value" :max="8" :precision="2">
          </rp-input-number>
        `,
                    data() {
                        return {
        ...
        it('precision greater than the precision of step', done => {
            vm = createVue(
                {
                    template: `
          <rp-input-number v-model="value" :max="8" :precision="0" :step="0.1">
          </rp-input-number>
        `,
                    data() {
                        return {
            ...
            const btnIncrease = vm.$el.querySelector('.rp-input-number__increase')
    ...
    it('controls', () => {
        vm = createVue(
            {
                template: `
        <rp-input-number :controls="false" v-model="value" :max="8">
        </rp-input-number>
      `,
                data() {
                    return {
        ...
        expect(vm.$el.querySelector('.rp-input-number__decrease')).to.not.exist
        expect(vm.$el.querySelector('.rp-input-number__increase')).to.not.exist
    })
    it('invalid value reset', done => {
        vm = createVue(
            {
                template: `
        <rp-input-number v-model="value" :min="5" :max="10" ref="inputNumber">
        </rp-input-number>
      `,
                data() {
                    return {
    ...
    describe('event:change', () => {
        ...
        beforeEach(() => {
            vm = createVue(
                {
                    template: `
          <rp-input-number v-model="value" ref="compo" :min='2' :max='3' :step='1'>
          </rp-input-number>
        `,
                    data() {
                        return {
    ...
    it('focus', done => {
        vm = createVue(
            {
                template: `
        <rp-input-number ref="input"></rp-input-number>
      `
            },
            true
        )
