...
describe('Loading', () => {
    ...
    describe('as a directive', () => {
      ...
      `,
            ...
            Vue.nextTick(() => {
                const mask = vm.$el.querySelector('.rp-loading-mask')
      ...
      `,
            ...
            Vue.nextTick(() => {
                ...
                Vue.nextTick(() => {
                    ...
                    vm2.show = false
                    Vue.nextTick(() => {
                        expect(document.querySelector('.rp-loading-mask')).to.not.exist
                        done()
                    })
                })
            })
      ...
      `,
            ...
            Vue.nextTick(() => {
                const mask = document.querySelector('.rp-loading-mask')
      ...
      `,
            ...
            Vue.nextTick(() => {
                ...
                vm.loading = false
                document.body.removeChild(document.querySelector('.rp-loading-mask'))
                document.body.removeChild(vm.$el)
                done()
            })
        })
      ...
      `,
            ...
            Vue.nextTick(() => {
                const mask = document.querySelector('.rp-loading-mask')
                const text = mask.querySelector('.rp-loading-text')
    ...
    describe('as a service', () => {
        it('create', () => {
            ...
            expect(document.querySelector('.rp-loading-mask')).to.exist
        })
      ...
      `
            ...
            let mask = document.querySelector('.rp-loading-mask')
      ...
      `
        ...
        it('fullscreen singleton', done => {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    let masks = document.querySelectorAll('.rp-loading-mask')
                    expect(masks.length).to.equal(1)
                    loadingInstance2.close()
                    setTimeout(() => {
                        masks = document.querySelectorAll('.rp-loading-mask')
        ...
        it('text', () => {
            ...
            const text = document.querySelector('.rp-loading-text')
            expect(text).to.exist
            expect(text.textContent).to.equal('Loading...')
        })

        it('customClass', () => {
            loadingInstance = Loading({ customClass: 'rp-loading-custom-class' })
            const customClass = document.querySelector('.rp-loading-custom-class')
