...
describe('Menu', () => {
        ...
        vm = createVue(
            {
                template: `
        <rp-menu>
          <rp-menu-item index="1" ref="item1">处理中心</rp-menu-item>
          <rp-menu-item index="2" ref="item2">订单管理</rp-menu-item>
        </rp-menu>
      `
            },
            true
        ...
        vm = createVue(
            {
                template: `
        <rp-menu>
          <rp-menu-item @click="onMenuItemClick" index="1" ref="item1">处理中心</rp-menu-item>
          <rp-menu-item index="2" ref="item2">订单管理</rp-menu-item>
        </rp-menu>
      `,
                methods: {
        ...
        vm = createVue(
            {
                template: `
        <rp-menu default-active="2">
          <rp-menu-item index="1" ref="item1" disabled>处理中心</rp-menu-item>
          <rp-menu-item index="2" ref="item2">订单管理</rp-menu-item>
        </rp-menu>
      `
            },
    ...
    describe('default active', () => {
        ...
        it('dynamic active', done => {
            vm = createVue(
                {
                    template: `
          <rp-menu :default-active="active">
            <rp-menu-item index="1" ref="item1">active watch处理中心</rp-menu-item>
            <rp-menu-item index="2" ref="item2">active watch订单管理</rp-menu-item>
          </rp-menu>
        `,
                    data() {
                        return {
            ...
            vm = createVue(
                {
                    template: `
          <div>
            <rp-menu default-active="2-2">
              <rp-menu-item index="1" ref="item1">处理中心</rp-menu-item>
              <rp-submenu index="2" ref="submenu">
                <template slot="title">我的工作台</template>
                <rp-menu-item index="2-1">选项1</rp-menu-item>
                <rp-menu-item index="2-2" ref="submenuItem2">选项2</rp-menu-item>
                <rp-menu-item index="2-3">选项3</rp-menu-item>
              </rp-submenu>
              <rp-menu-item index="3">订单管理</rp-menu-item>
            </rp-menu>
          </div>
        `
                },
    ...
    describe('submenu', function() {
        ...
        `,
            ...
            submenu.$el.querySelector('.rp-submenu__title').click()
            setTimeout(_ => {
        ...
        it('default opened', done => {
            vm = createVue(
                {
                    template: `
          <rp-menu :default-openeds="defaultOpeneds">
            <rp-menu-item index="1">default opened处理中心</rp-menu-item>
            <rp-submenu index="2" ref="submenu1">
              <template slot="title">default opened我的工作台</template>
              <rp-menu-item index="2-1">选项1</rp-menu-item>
              <rp-menu-item index="2-2" ref="submenu1Item2">选项2</rp-menu-item>
              <rp-menu-item index="2-3">选项3</rp-menu-item>
            </rp-submenu>
            <rp-submenu index="3" ref="submenu2">
              <template slot="title">default opened订单管理</template>
              <rp-menu-item index="3-1">选项1</rp-menu-item>
              <rp-menu-item index="3-2" ref="submenu2Item2">选项2</rp-menu-item>
        ...
        it('disabled', done => {
          ...
          <rp-menu>
            <rp-menu-item index="1" ref="item1">处理中心</rp-menu-item>
            <rp-submenu index="2" ref="submenu" disabled>
              <template slot="title">我的工作台</template>
              <rp-menu-item index="2-1">选项1</rp-menu-item>
              <rp-menu-item index="2-2" ref="submenuItem2">选项2</rp-menu-item>
              <rp-menu-item index="2-3">选项3</rp-menu-item>
    ...
    it('unique-opened', done => {
        vm = createVue(
            {
                template: `
        <rp-menu unique-opened default-active="2-2">
      ...
      `,
        ...
        vm.$refs.submenu2.$el.querySelector('.rp-submenu__title').click()
        setTimeout(_ => {
    ...
    it('horizontal mode', done => {
      ...
      `,
        ...
        expect(vm.$el.classList.contains('rp-menu--horizontal')).to.be.true
        var submenu = vm.$refs.submenu
        triggerEvent(submenu.$el, 'mouseenter')
        setTimeout(_ => {
            expect(document.body.querySelector('.rp-menu--popup').parentElement.style.display).to.not.ok
            done()
        }, 500)
    })
    it('menu trigger click', done => {
        vm = createVue(
            {
                template: `
        <rp-menu mode="horizontal" menu-trigger="click">
          <rp-menu-item index="1">处理中心</rp-menu-item>
          <rp-submenu index="2" ref="submenu">
            <template slot="title">我的工作台</template>
            <rp-menu-item index="2-1">选项1</rp-menu-item>
      ...
      `,
        ...
        expect(vm.$el.classList.contains('rp-menu--horizontal')).to.be.true
        var submenu = vm.$refs.submenu
        var triggerElm = submenu.$el.querySelector('.rp-submenu__title')
        ...
        setTimeout(_ => {
            ...
            triggerElm.click()
            setTimeout(_ => {
                expect(document.body.querySelector('.rp-menu--popup').parentElement.style.display).to.be.equal('none')
                done()
            }, 1000)
        }, 500)
    })
    it('menu group', () => {
        vm = createVue(
            {
                template: `
        <rp-menu mode="vertical" default-active="1">
          <rp-menu-item-group title="分组一" ref="group1">
            <rp-menu-item index="1"><i class="rp-icon-message"></i>导航一</rp-menu-item>
            <rp-menu-item index="2"><i class="rp-icon-message"></i>导航二</rp-menu-item>
          </rp-menu-item-group>
          <rp-submenu index="5">
            <template slot="title">导航五</template>
            <rp-menu-item-group title="分组二">
              <rp-menu-item index="5-1">选项1</rp-menu-item>
              <rp-menu-item index="5-2">选项2</rp-menu-item>
            </rp-menu-item-group>
          </rp-submenu>
        </rp-menu>
      `
        ...
        expect(vm.$refs.group1.$el.querySelector('.rp-menu-item-group__title').innerText).to.be.equal('分组一')
    })
    it('dynamic menus, issue 9092', done => {
        ...
        setTimeout(_ => {
            ...
            setTimeout(_ => {
                expect(vm.$el.querySelector('.rp-menu-item.is-active').innerText).to.equal('new')
                done()
            }, 20)
        }, 100)
    })
