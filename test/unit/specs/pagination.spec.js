...
describe('Pagination', () => {
    ...
    it('create', () => {
        ...
        // pager
        expect(elm.querySelector('ul.rp-pager')).to.exist
        // next
        expect(elm.querySelector('button.btn-next')).to.exist
        // jumper
        expect(elm.querySelector('.rp-pagination__jump')).to.exist
        // ->
        expect(elm.querySelector('.rp-pagination__rightwrapper')).to.exist
    })
    ...
    it('set layout', () => {
        ...
        expect(elm.querySelector('button.btn-next')).to.exist
        // not found jumper
        expect(elm.querySelector('.rp-pagination__jump')).to.not.exist
        // not found ->
        expect(elm.querySelector('.rp-pagination__rightwrapper')).to.not.exist
        // not found total
        expect(elm.querySelector('.rp-pagination__total')).to.not.exist
    })
    ...
    it('layout: all in right, need clear float', () => {
        ...
        const elm = vm.$el
        let right_div = elm.querySelector('.rp-pagination__rightwrapper')
    ...
    it('small', () => {
        ...
        expect(vm.$el.classList.contains('rp-pagination--small')).to.true
    })
    ...
    it('pageSizes', () => {
        ...
        expect(vm.$el.querySelector('.rp-select-dropdown__item.selected'))
            .to.property('textContent')
            .include('35')
        expect([].slice.call(vm.$el.querySelectorAll('.rp-select-dropdown__item')).map(node => parseInt(node.textContent, 10))).to.deep.equal([
            10,
            15,
            35,
            50
    ...
    it('event:size-change', done => {
      ...
      `,
        ...
        setTimeout(_ => {
            vm.$el.querySelectorAll('li.rp-select-dropdown__item')[1].click()
            setTimeout(_ => {
    ...
    it('pageSize > total', () => {
      ...
      `,
        ...
        const input = vm.$el.querySelector('.rp-pagination__jump input')
    ...
    describe('click pager', () => {
        it('click ul', () => {
            ...
            vm.$el.querySelector('.rp-pager').click()
        ...
        it('click li', () => {
            ...
            vm.$el.querySelectorAll('.rp-pager li.number')[1].click()
        ...
        it('click next icon-more', () => {
            ...
            vm.$el.querySelector('.rp-pager .more').click()
