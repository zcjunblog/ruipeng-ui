...
describe('Radio', () => {
    ...
    it('create', done => {
        vm = createVue(
            {
                template: `
        <rp-radio v-model="radio" label="a">
        </rp-radio>
      `,
                data() {
                    return {
        ...
        let radioElm = vm.$el
        expect(radioElm.classList.contains('rp-radio')).to.be.true
        radioElm.click()
        setTimeout(_ => {
    ...
    describe('Radio group', () => {
        it('create', done => {
          ...
          <rp-radio-group v-model="radio">
            <rp-radio :label="3" ref="radio1">备选项</rp-radio>
            <rp-radio :label="6" ref="radio2">备选项</rp-radio>
        ...
        it('disabled', done => {
            vm = createVue(
                {
                    template: `
          <rp-radio-group v-model="radio" disabled>
            <rp-radio :label="3" ref="radio1">备选项</rp-radio>
            <rp-radio :label="6" ref="radio2">备选项</rp-radio>
            <rp-radio :label="9">备选项</rp-radio>
          </rp-radio-group>
        ...
        it('change event', done => {
            vm = createVue(
                {
                    template: `
          <rp-radio-group v-model="radio" @change="onChange">
            ...
            vm = createVue(
                {
                    template: `
          <rp-radio-group v-model="radio" disabled>
            <rp-radio-button :label="3" ref="radio1">备选项</rp-radio-button>
            <rp-radio-button :label="6" ref="radio2">备选项</rp-radio-button>
            <rp-radio-button :label="9">备选项</rp-radio-button>
          </rp-radio-group>
        `,
                    data() {
                        return {
            ...
            vm = createVue(
                {
                    template: `
          <rp-radio-group v-model="radio">
            <rp-radio-button ref="radio1" :label="3">备选项</rp-radio-button>
            <rp-radio-button ref="radio2" :label="6">备选项</rp-radio-button>
            <rp-radio-button ref="radio3" :label="9">备选项</rp-radio-button>
          </rp-radio-group>
        `,
                    data() {
                        return {
        ...
        describe('Radio Button', () => {
          ...
          `,
            ...
            it('custom color', done => {
                vm = createVue(
                    {
                        template: `
            <rp-radio-group v-model="radio" fill="#000" text-color="#ff0">
              <rp-radio-button :label="3" ref="radio1">备选项</rp-radio-button>
              <rp-radio-button :label="6" ref="radio2">备选项</rp-radio-button>
              <rp-radio-button :label="9">备选项</rp-radio-button>
            </rp-radio-group>
                ...
                vm = createVue(
                    {
                        template: `
            <rp-radio-group v-model="radio" @change="onChange">
              <rp-radio-button :label="3">备选项</rp-radio-button>
              <rp-radio-button :label="6" ref="radio2">备选项</rp-radio-button>
              <rp-radio-button :label="9">备选项</rp-radio-button>
            </rp-radio-group>
          `,
          ...
          `,
            ...
            it('size', done => {
                vm = createVue(
                    {
                        template: `
            <rp-radio-group v-model="radio" size="large">
              <rp-radio-button :label="3" ref="radio1">备选项</rp-radio-button>
              <rp-radio-button :label="6" ref="radio2">备选项</rp-radio-button>
              <rp-radio-button :label="9">备选项</rp-radio-button>
            </rp-radio-group>
          `,
                ...
                setTimeout(_ => {
                    expect(vm.$el.querySelectorAll('.rp-radio-button--large').length).to.be.equal(3)
                    done()
                }, 10)
            })
        })
