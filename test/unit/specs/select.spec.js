...
describe('Select', () => {
    ...
    it('create', () => {
        ...
        expect(vm.$el.className).to.equal('rp-select')
        expect(vm.$el.querySelector('.rp-input__inner').placeholder).to.equal('请选择')
        vm.toggleMenu()
    ...
    it('options rendered correctly', () => {
        vm = getSelectVm()
        const options = vm.$el.querySelectorAll('.rp-select-dropdown__item')
    ...
    it('custom dropdown class', () => {
        ...
        const dropdown = vm.$el.querySelector('.rp-select-dropdown')
    ...
    it('default value', done => {
      ...
      `,
        ...
        setTimeout(() => {
            expect(vm.$el.querySelector('.rp-input__inner').value).to.equal('双皮奶')
            done()
        }, 100)
    })
        ...
        vm = createVue(
            {
                template: `
        <div>
          <rp-select v-model="value" @change="handleChange">
            <rp-option
              v-for="item in options"
              :label="item.label"
              :key="item.value"
    ...
    it('disabled select', () => {
        ...
        expect(vm.$el.querySelector('.rp-input').classList.contains('is-disabled')).to.true
    })
        ...
        vm = createVue(
            {
                template: `
        <div>
          <rp-select v-model="value" @visible-change="handleVisibleChange">
            <rp-option
              v-for="item in options"
              :label="item.label"
              :key="item.value"
    ...
    it('clearable', done => {
        ...
        setTimeout(() => {
            const iconClear = vm.$el.querySelector('.rp-input__icon.rp-icon-circle-close')
    ...
    it('object typed value', done => {
        vm = createVue(
            {
                template: `
        <div>
          <rp-select v-model="value" value-key="id">
            <rp-option
              v-for="item in options"
              :label="item.label"
              :key="item.id"
      ...
      `,
        ...
        setTimeout(() => {
            expect(vm.$el.querySelector('.rp-input__inner').value).to.equal('label1')
            expect(vm.$el.querySelector('.rp-select-dropdown__item').classList.contains('selected'))
            done()
        }, 100)
    })
    ...
    it('prefixed icon', () => {
      ...
      `,
        ...
        expect(vm.$el.querySelector('.rp-input__icon').classList.contains('rp-icon-search')).to.be.true
    })

    it('custom rp-option template', () => {
        vm = createVue(
            {
                template: `
        <div>
      ...
      `,
        ...
        expect(vm.$el.querySelector('.rp-select-dropdown__item p').textContent).to.equal('label value')
    })
    ...
    it('option group', () => {
      ...
      `,
        ...
        const groups = vm.$el.querySelectorAll('.rp-select-group__wrap')
        const options = groups[1].querySelectorAll('.rp-select-dropdown__item')
    ...
    it('allow create', done => {
        ...
        setTimeout(() => {
            ...
            select.onInputChange()
            setTimeout(() => {
                const options = document.querySelectorAll('.rp-select-dropdown__item span')
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    const tagCloseIcons = vm.$el.querySelectorAll('.rp-tag__close')
        ...
        vm = createVue(
            {
                template: `
        <div>
          <rp-select v-model="value" multiple @remove-tag="handleRemoveTag">
            <rp-option
              v-for="item in options"
              :label="item.label"
              :key="item.value"
    ...
    it('event:focus & blur', done => {
        vm = createVue(
            {
                template: `
        <rp-select ref="select"></rp-select>
      `
            },
            true
        )
        ...
        vm = createVue(
            {
                template: `
        <div>
          <rp-select v-model="value" ref="select">
            <rp-option label="1" :value="1" />
          </rp-select>
        </div>
      `,
                data() {
        ...
        const option = vm.$el.querySelectorAll('.rp-select-dropdown__item')[0]
    ...
    it('only emit change on user input', done => {
        ...
        vm = createVue({
            template: `
        <div>
          <rp-select v-model="value" @change="change" ref="select">
            <rp-option label="1" :value="1" />
            <rp-option label="2" :value="2" />
            <rp-option label="3" :value="3" />
          </rp-select>
        </div>
      `,
            data() {
    ...
    it('should set placeholder to label of selected option when filterable is true and multiple is false', async () => {
        vm = createVue({
            template: `
        <div>
          <rp-select ref="select" v-model="value" filterable>
            <rp-option label="test" value="test" />
          </rp-select>
        </div>
      `,
            data() {
        ...
        expect(vm.$el.querySelector('.rp-input__inner').placeholder).to.be.equal('test')
    ...
    it('default value is null or undefined', async () => {
      ...
      `,
        ...
        vm.value = null
        await waitImmediate()
        expect(vm.$el.querySelector('.rp-input__inner').value).to.equal('')
        vm.value = '选项1'
        await waitImmediate()
        expect(vm.$el.querySelector('.rp-input__inner').value).to.equal('黄金糕')
    })
