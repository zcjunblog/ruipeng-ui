...
describe('Upload', () => {
    ...
    describe('ajax upload', () => {
            ...
            uploader = createVue(
                {
                    render(h) {
                        return (
                            <rp-upload {...props} ref="upload">
                                <rp-button size="small" type="primary">
                                    点击上传
                                </rp-button>
                            </rp-upload>
                        )
        ...
        it('preview file', done => {
            ...
            handlers.onSuccess = (res, file, fileList) => {
                uploader.$nextTick(_ => {
                    uploader.$el.querySelector('.rp-upload-list .is-success a').click()
                })
            }
        ...
        it('file remove', done => {
            ...
            handlers.onSuccess = (res, file, fileList) => {
                uploader.$el.querySelector('.rp-upload-list .rp-icon-close').click()
                uploader.$nextTick(_ => {
